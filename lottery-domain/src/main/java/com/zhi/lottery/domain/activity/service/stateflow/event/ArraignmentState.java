package com.zhi.lottery.domain.activity.service.stateflow.event;

import com.zhi.lottery.common.Constants;
import com.zhi.lottery.common.Result;
import com.zhi.lottery.domain.activity.service.stateflow.AbstractState;
...
public class ArraignmentState extends AbstractState {
    ...
    public Result arraignment(Long activityId, Enum<Constants.ActivityState> currentState) {
        return Result.buildResult(Constants.ResponseCode.UN_ERROR, "待审状态不可重复提审");
    }
